...
urlpatterns = [
    ...
    path("author/details/<int:pk", AuthorDetailsView.as_view()),
    ...
    path("genre/details/<int:pk", GenreDetailsView.as_view()),
    ...
    path("publisher/details/<int:pk", PublisherDetailsView.as_view()),
